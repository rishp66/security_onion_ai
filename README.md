...
A Terraform-deployed Azure lab for demonstrating Security Onion's native AI capabilities: AI Summaries, Guided Analysis, Playbooks, and the Onion AI Assistant while using real attack traffic that you can create yourself!
